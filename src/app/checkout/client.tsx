...
export default function CheckoutClient({ session } : CheckoutClientProps) {
  ...
  return (
    <div className="flex flex-col items-center justify-center">
      <div className="bg-neutral-100 w-screen h-50 flex flex-row items-center justify-around overflow-hidden shadow-2xs">
    ...
    <div className="container mx-auto px-4 py-8 flex flex-col lg:flex-row items-center justify-center h-full lg:gap-30 animate-in fade-in-translate-full duration-700 slide-in-from-bottom-20">
